...
class Article
  ...
  module CommonRelationMethods
    ...
    sig do
      ...
      ).returns(T.nilable(T::Enumerator[::Article]))
    end
    ...
    sig do
      params(
        ...
        error_on_ignore: T.untyped,
        order: Symbol,
        block: T.nilable(T.proc.params(object: T::Array[::Article]).void)
      ).returns(T.nilable(T::Enumerator[T::Enumerator[::Article]]))
    end
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Article` class because it declared `has_many :comments`.
